...
- Telling the agent to "push directly to the default branch" → cloud agents push to a sandbox feature branch by default and ignore such directives. Honor the natural flow: feature branch + PR.
